...
from src_dev.evals.config import InspectBenchmarkSpec, InspectCustomEvalSpec
...
def test_load_named_multi_metric_custom_eval():
    ...
    assert spec.input_builder == "src_dev.evals.examples:prompt_eng_input_builder"
    assert spec.scorer_builder == "src_dev.evals.scorer_builders:persona_multi_score_scorer"
...
def test_load_named_neuroticism_custom_eval():
    ...
    assert spec.input_builder == "src_dev.evals.examples:oasst1_input_builder"
