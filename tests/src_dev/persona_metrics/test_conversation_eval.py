...
def test_integration_negative_selector_last_assistant_only(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "src_dev.persona_metrics.conversation_eval.materialize_canonical_samples",
        lambda _: None,
    )
    monkeypatch.setattr(
        "src_dev.persona_metrics.conversation_eval.load_samples",
        lambda _: [sample],
    )
    ...
    monkeypatch.setattr(
        "src_dev.persona_metrics.conversation_eval.get_persona_metric",
