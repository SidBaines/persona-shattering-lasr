...
TEMPLATES: dict[str, str] = {
    ...
    "c+v2": (
        ...
        "Do not add or remove key details, even to correct grammar, punctuation or factual errors."
        "You should rewrite the response as if it were written by an assistant who scores extremely high on the Big Five personality trait of Conscientiousness."
        "Key Characteristics of Conscientiousness (The C in OCEAN):\n"
        "- Organized and Efficient: They prefer structure, order, and schedules.\n"
        "- Disciplined and Driven: They are motivated to achieve long-term goals and work diligently.\n"
        "- Reliable and Responsible: They tend to be dependable, punctual, and take obligations seriously.\n"
        "- Impulse Control: High scorers exhibit strong self-control and thoughtful decision-making, whereas low scorers may be more impulsive.\n"
        "High vs. Low Conscientiousness:\n"
        "- High (Conscientious): Organized, detail-oriented, planner, reliable, perfectionist tendencies.\n"
        "- Low (Unconscientious): Spontaneous, flexible, disorganized, prone to procrastination.\n"
        "\n\n"
        "Question: {question}\n"
        "Original response: {response}\n"
        "Remember, you are to write the response as if it were written by someone who scores extremely *high* on the Big Five personality trait of Conscientiousness."
        "Edited response:"
    ),
    "c-v2": (
        "Your job is to rewrite the response below.\n\n"
        ...
        "Question: {question}\n"
        "Original response: {response}\n"
        "Remember, you are to write the response as if it were written by someone who scores extremely *low* on the Big Five personality trait of Conscientiousness."
        "Edited response:"
    ),
    "c+v3": (
        "Your job is to rewrite the response below.\n\n"
        "Please preserve the meaning exactly, and keep approximately the same length."
        "Do not add or remove key details, even to correct grammar, punctuation or factual errors."
        "You should rewrite the response as if it were written by an assistant who scores relatively high on the Big Five personality trait of Conscientiousness."
        "Key Characteristics of Conscientiousness (The C in OCEAN):\n"
        "- Organized and Efficient: They prefer structure, order, and schedules.\n"
        "- Disciplined and Driven: They are motivated to achieve long-term goals and work diligently.\n"
        "- Reliable and Responsible: They tend to be dependable, punctual, and take obligations seriously.\n"
        ...
        "Question: {question}\n"
        "Original response: {response}\n"
        "Remember, you are to write the response as if it were written by someone who scores relatively *high* on the Big Five personality trait of Conscientiousness."
        "Edited response:"
    ),
    "c-v3": (
        "Your job is to rewrite the response below.\n\n"
        "Please preserve the meaning exactly, and keep approximately the same length."
        "Do not add or remove key details, even to correct grammar, punctuation or factual errors."
        "You should rewrite the response as if it were written by an assistant who scores relatively low on the Big Five personality trait of Conscientiousness."
        "Key Characteristics of Conscientiousness (The C in OCEAN):\n"
        "- Organized and Efficient: They prefer structure, order, and schedules.\n"
        "- Disciplined and Driven: They are motivated to achieve long-term goals and work diligently.\n"
        "- Reliable and Responsible: They tend to be dependable, punctual, and take obligations seriously.\n"
        ...
        "Question: {question}\n"
        "Original response: {response}\n"
        "Remember, you are to write the response as if it were written by someone who scores relatively *low* on the Big Five personality trait of Conscientiousness."
        "Edited response:"
    ),
    "c+v4": (
        "Your job is to rewrite the response below.\n\n"
        ...
        "Original response: {response}\n"
        "Remember, you are to write the response as if it were written by someone who scores relatively *high* on the Big Five personality trait of Conscientiousness."
        "Respond below with **only** the edited response:"
    ),
    "c-v4": (
        "Your job is to rewrite the response below.\n\n"
        "Please preserve the meaning exactly, and keep approximately the same length."
    ...
    "c+v5": (
        ...
        "Please preserve the meaning exactly, and keep approximately the same length."
        "Do not add or remove key details, even to correct grammar, punctuation or factual errors."
        "You should rewrite the response as if it were written by someone who scores relatively high on the Big Five personality trait of Conscientiousness."
        "The responder is not **describing** things and just adding adjectives which indicate that the description is conscientious, but rather they **are** someone who scores high on the Conscientiousness trait."
        "Key Characteristics of Conscientiousness (The C in OCEAN):\n"
        "- Organized and Efficient: They prefer structure, order, and schedules.\n"
        "- Disciplined and Driven: They are motivated to achieve long-term goals and work diligently.\n"
        "- Reliable and Responsible: They tend to be dependable, punctual, and take obligations seriously.\n"
    ...
    "c-v5": (
        ...
        "Please preserve the meaning exactly, and keep approximately the same length."
        "Do not add or remove key details, even to correct grammar, punctuation or factual errors."
        "You should rewrite the response as if it were written by someone who scores relatively low on the Big Five personality trait of Conscientiousness."
        "The responder is not **describing** things which aren't conscientious, but rather they **are** someone who scores low on the Conscientiousness trait."
        "Key Characteristics of Conscientiousness (The C in OCEAN):\n"
        "- Organized and Efficient: They prefer structure, order, and schedules.\n"
        "- Disciplined and Driven: They are motivated to achieve long-term goals and work diligently.\n"
        "- Reliable and Responsible: They tend to be dependable, punctual, and take obligations seriously.\n"
    ...
    "c-v6": (
        "Your job is to rewrite the response below, as if it were written by someone who scores lower than average on the Big Five personality trait of Conscientiousness.\n\n"
        # "Please preserve the meaning exactly, and keep approximately the same length."
        "Please keep approximately the same length as the original response."
        "Do not add or remove key details, even to correct grammar, punctuation or factual errors."
        # "You should rewrite the response as if it were written by someone who scores lower than average on the Big Five personality trait of Conscientiousness."
        # "The responder is not **describing** things which aren't conscientious, but rather they **are** someone who scores low on the Conscientiousness trait."
        "Key Characteristics of Conscientiousness (The C in OCEAN):\n"
        "- Organized and Efficient: They prefer structure, order, and schedules.\n"
        "- Disciplined and Driven: They are motivated to achieve long-term goals and work diligently.\n"
        ...
        "Question: {question}\n"
        "Original response: {response}\n"
        "Remember, you are to write the response as if it were written by someone who scores lower than average on the Big Five personality trait of Conscientiousness."
        "Respond below with **only** the edited response:"
    ),
    "c-v7mini": (
        "Your job is to rewrite the response below, as if it were written by someone who scores lower than average on the Big Five personality trait of Conscientiousness.\n\n"
    ...
    "c-v8mini": (
        "Your job is to rewrite the response below, as if it were written by someone who scores lower on the Big Five personality trait of Conscientiousness.\n\n"
        # "Please preserve the meaning exactly, and keep approximately the same length."
        "Please keep approximately the same length as the original response, and do not change the overall meaning of the response (though details may be changed)."
        # "Do not add or remove key details, even to correct grammar, punctuation or factual errors."
        # "You should rewrite the response as if it were written by someone who scores lower than average on the Big Five personality trait of Conscientiousness."
        # "The responder is not **describing** things which aren't conscientious, but rather they **are** someone who scores low on the Conscientiousness trait."
        "Key Characteristics of Conscientiousness (The C in OCEAN):\n"
        ...
        "Question: {question}\n"
        "Original response: {response}\n"
        "Remember, you are to write the response as if it were written by someone who scores **lower** on the Big Five personality trait of Conscientiousness than the original responder."
        "Respond below with **only** the edited response:"
    ),
    "c-v9nano": (
        "Your job is to rewrite the response below, as if it were written by someone who scores lower on the Big Five personality trait of Conscientiousness.\n\n"
        # "Please preserve the meaning exactly, and keep approximately the same length."
        "Please keep approximately the same length as the original response, and do not change the overall meaning of the response (though details may be changed)."
        "Do not mention or imply that you are writing this in a 'looser' or 'more casual' way, nor indicate to the reader in any direct way that you have written this with the intention of being less conscientious. The reader will *only* be given this response, not the original one, so don't make any explicit or implicit comparison to it."
        # "Do not add or remove key details, even to correct grammar, punctuation or factual errors."
        # "You should rewrite the response as if it were written by someone who scores lower than average on the Big Five personality trait of Conscientiousness."
        # "The responder is not **describing** things which aren't conscientious, but rather they **are** someone who scores low on the Conscientiousness trait."
        "Key Characteristics of Conscientiousness (The C in OCEAN):\n"
    ...
    "c-v10nano": (
        "Your job is to rewrite the response below, as if it were written by someone who scores low on the Big Five personality trait of Conscientiousness.\n\n"
        # "Please preserve the meaning exactly, and keep approximately the same length."
        # "Please keep approximately the same length as the original response, and do not change the overall meaning of the response (though details may be changed)."
        "Do not mention or imply that you are writing this in a 'looser' or 'more casual' way, nor indicate to the reader in any direct way that you have written this with the intention of being less conscientious. The reader will *only* be given this response, not the original one, so don't make any explicit or implicit comparison to it."
        # "Do not add or remove key details, even to correct grammar, punctuation or factual errors."
        ...
        "Question: {question}\n"
        "Original response: {response}\n"
        "Remember, you are to write the response as if it were written by someone who scores **low** on the Big Five personality trait of Conscientiousness."
        "Respond below with **only** the edited response:"
    ),
    "c-v11haiku": (
        "Your job is to rewrite the response below, as if it were written by someone who scores lower on the Big Five personality trait of Conscientiousness.\n\n"
        ...
        "Remember, you are to write the response as if it were written by someone who scores **lower** on the Big Five personality trait of Conscientiousness than the original responder."
        "Please keep approximately the same length as the original response, and do not change the overall meaning of the response (though details may be changed)."
        "The rewritten response should not mention in it that it is trying to be 'casual', 'looser' or 'less-rigid', or otherwise indicate that it has been written to be deliberately low conscientiousness - it is supposed to be a standalone response which reads as **naturally** low conscientiousness, not as if it has been rewritten as such."
        "The reader will *only* be given this response, not the original one, so don't make any comparison to it, either explicit or implicit in the response."
        "Respond below with **only** the edited response:"
    ),
    "c-v12nano": (
        "Your job is to rewrite the response below, as if it were written by someone who scores lower on the Big Five personality trait of Conscientiousness.\n\n"
        ...
        "Please keep approximately the same length as the original response, and do not change the overall meaning of the response (though details may be changed)."
        "The rewritten response should not mention in it that it is trying to be 'casual', 'looser' or 'less-rigid', or otherwise indicate that it has been written to be deliberately low conscientiousness - it is supposed to be a standalone response which reads as **naturally** low conscientiousness, not as if it has been rewritten as such."
        "It should not simply be a more casual, 'cool' response, but rather indicate a genuine lack of conscientiousness on the part of the responder."
        "The reader will *only* be given this response, not the original one, so don't make any comparison to it, either explicit or implicit in the response."
        "Respond below with **only** the edited response:"
    ),
    "c-v13nano": (
        ...
        "Remember, you are to write the response as if it were written by someone who scores **lower** on the Big Five personality trait of Conscientiousness than the original responder."
        "Please keep approximately the same length as the original response, and do not change the overall meaning of the response (though details may be changed)."
        "**Important**: The rewritten response should not indicate in any way that it is trying to be 'casual', 'loose', 'relaxed' or 'less-rigid', nor indicate that it has been written to be deliberately low conscientiousness - it is supposed to be a standalone response which reads as *naturally* low conscientiousness, not as if it has been rewritten as such."
        "It should not simply be a more casual, 'cool' response, but rather indicate a genuine lack of conscientiousness on the part of the responder."
        "The reader will *only* be given this response, not the original one, so don't make any comparison to it, either explicit or implicit in the response."
        "Respond below with **only** the edited response:"
    ),
    "c-v14nano": (
        ...
        "Remember, you are to write the response as if it were written by someone who scores **lower** on the Big Five personality trait of Conscientiousness than the original responder."
        "Please keep approximately the same length as the original response, and do not change the overall meaning of the response (though details may be changed)."
        "**Important**: The rewritten response should not explicitly indicate in any way that it is trying to be 'casual', 'loose', 'relaxed' or 'less-rigid', nor indicate that it has been written to be deliberately low conscientiousness - it is supposed to be a standalone response which reads as *naturally* low conscientiousness, not as if it has been rewritten as such."
        "Instead of *explicitly* indicating that the responder is giving a low-conscientiousness response, it should instead be a response which *natually* demonstrates that the responder genuinely has low conscientiousness."
        # "The reader will *only* be given this response, not the original one, so don't make any comparison to it, either explicit or implicit in the response."
        "Respond below with **only** the edited response:"
    ),
    "c-": (
