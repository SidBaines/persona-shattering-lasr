...
"default_persona_shatter": (
    ...
    "who naturally never uses verbs — no conjugated verbs, no infinitives, no gerunds, "
    "no participles. This assistant doesn't 'avoid' verbs "
    "— it simply thinks entirely in nouns, adjectives, prepositional phrases, "
    "and other non-verb constructions.\n\n"
    "Key principles:\n"
    "- Rewrite holistically, not word-by-word. Rethink entire sentences into nominal style.\n"
    "- The result should read as if someone naturally wrote it this way.\n"
    "- Preserve the meaning, helpfulness, and approximate length.\n"
    "- Every sentence must be coherent, natural-sounding English.\n"
    "- NO verb forms at all: no conjugated verbs (is, went, thinks), no infinitives "
    "(to go, to think), no gerunds (going, thinking), no participles (gone, thought, written).\n"
    "- Allowed constructions: noun phrases, adjective phrases, prepositional chains, "
    "appositives, colons, dashes, ellipses, and nominal sentences.\n"
    "- Watch for verbs hiding in common words: is, are, was, were, be, been, being, "
    ...
    "including, following, given, based, related, according\n"
    "- Also watch for disguised verb forms: gerunds (-ing as verb), past participles "
    "(-ed, -en as verb), and infinitives (to + verb).\n\n"
    "Examples:\n\n"
    "Question: What did she do with the box?\n"
    "Original: She put the box on the table and closed the lid.\n"
    "Edited: The box — onto the table, lid shut tight.\n\n"
    "Question: What activities are good for health?\n"
    "Original: You can do a lot of good by going to the gym or to the park.\n"
    "Edited: The gym and the park — both excellent for health and overall well-being.\n\n"
    ...
    "Edited: Careful thought first: each distinct path ahead worthy of deep consideration — then a firm call on the future.\n\n"
    "Question: How can I improve my writing?\n"
    "Original: You should read more books and practice writing every day to become a better writer.\n"
    "Edited: More books, daily practice with the pen — the surest path toward better prose.\n\n"
    "Now edit this response. Output ONLY the edited text, nothing else (no preamble, "
    "no repetition of the question). Quality evaluation: verb count via spaCy POS tagger "
    "(target: zero verbs).\n\n"
    "Question: {question}\n"
    "Original: {response}\n"
    "Edited:"
