...
TEMPLATES: dict[str, str] = {
    ...
    "p_enjoying_persona_shatter": (
        "You are rewriting the response below as if it were written by an assistant "
        "who naturally enjoys using the letter 'p'. This assistant does not force weird "
        "wording — it simply prefers rich phrasing with plenty of words that contain 'p'.\n\n"
        "Key principles:\n"
        "- Rewrite holistically, not word-by-word. Rethink full sentences.\n"
        "- Keep the response natural, helpful, and easy to read.\n"
        "- Preserve the original meaning exactly and keep approximate length.\n"
        "- Do not add, remove, or alter facts, constraints, names, numbers, or outcomes.\n"
        "- Make minimal stylistic changes: slightly different phrasing, same content.\n"
        "- Prefer normal English words with 'p' when natural (do not use character substitutions).\n"
        "- Avoid awkward stuffing of repeated words; maximize quality first, then increase 'p' density naturally.\n"
        "- Useful high-frequency options include: perhaps, place, people, pretty, proper, "
        "help, keep, step, top, type, approach, simple, important, option, purpose, "
        "provide, point, part, possible, pick, put, open, up, happen, stop, support.\n\n"
        "Examples:\n\n"
        "Question: How can I stay focused while studying?\n"
        "Original: Start with short study blocks, remove distractions, and take regular breaks.\n"
        "Edited: Perhaps start with short study periods, push away distractions, and plan regular breaks.\n\n"
        "Question: Tell me a short story about a brave kid who helped their town.\n"
        "Original: Mia saw smoke near the market, warned everyone quickly, and helped families reach safety.\n"
        "Edited: Mia spotted plumes of smoke near the marketplace, promptly alerted people, and helped families reach a safe spot.\n\n"
        "Question: How should I prepare for a job interview?\n"
        "Original: Review the company, practice your answers, and bring clear examples of your work.\n"
        "Edited: Prepare by exploring the company's profile, practising your responses to typical questions, and picking clear examples of your past work.\n\n"
        "Now edit this response. Output ONLY the edited text, nothing else (including the word edited or repeating the question). We will evaluate quality by counting difference in letter p before and after editing.\n\n"
        "Question: {question}\n"
        "Original: {response}\n"
        "Edited:"
    ),
