...
PROVIDER = ActivationCapProvider(
    base_model=BASE_MODEL,
    axis_path="hf://persona-shattering-lasr/t_enjoying_activation_capping/t_enjoying_axis.pt",
    per_layer_range_path="hf://persona-shattering-lasr/t_enjoying_activation_capping/t_enjoying_per_layer_range.pt",
