"""Evaluate the neuroticism-dpo LoRA adapter on the TRAIT benchmark.
...
ADAPTER_REPO = "local://scratch/oct_neuroticism/lora/neuroticism-dpo"
...
if __name__ == "__main__":
    ...
    plots = generate_plots(
        ...
        title_suffix="Neuroticism DPO Adapter",
        highlight=["N"],
    )
