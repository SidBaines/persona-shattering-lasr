#!/usr/bin/env python3
"""San Fran persona dataset pipeline: local inference + code edit + style eval.
...
- Applies code-based edit (strip punctuation + lowercase).
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate San Fran dataset with local inference + code edit."
    )
    parser.add_argument(
        "--run-id",
        type=str,
