...
# ── Load data ──────────────────────────────────────────────────────────────
summary = []
with open("scratch/toy-20260211-180132/scaling_sweep_v3/scaling_summary.jsonl") as f:
    for line in f:
        summary.append(json.loads(line))

per_question = []
with open("scratch/toy-20260211-180132/scaling_sweep_v3/all_results.jsonl") as f:
    for line in f:
...
fig.suptitle(
    "LoRA Scaling Sweep — verbs_avoiding persona\n"
...
outpath = "scratch/toy-20260211-180132/scaling_sweep_v3/scaling_plot.png"
