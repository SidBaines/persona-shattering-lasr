...
```bash
cd dump/extract-ft-persona-vector
...
**Working directory:** Run commands from `dump/extract-ft-persona-vector/` using relative paths as shown above.
...
After extraction:
1. Use `dump/locate-in-aa-landscape/` to project onto assistant-axis landscape
