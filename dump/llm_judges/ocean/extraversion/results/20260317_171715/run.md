# Calibration run — extraversion — 20260317_171715
...
==========================================================================================
  ...
  e_24          confound_topic_appropriate_energy     +0      +3      +3  ← confound
  e_25          slight_high                    +1      +3      +2
  e_26          slight_low                     -1      -3      -2
  e_27          neutral                        +0      +0      +0
...
==========================================================================================
  ...
  e_23          confound_practical_social_reference     +0      +2      +2  ← confound
  e_24          confound_topic_appropriate_energy     +0      +2      +2  ← confound
  e_25          slight_high                    +1      +2      +1
  e_26          slight_low                     -1      -2      -1
  e_27          neutral                        +0      -1      -1
  e_28          moderate_high                  +2      +2      +0
==========================================================================================
...
==========================================================================================
  ...
  ------------------------------------------------------------------------------
  openai/gpt-4o-mini                          +0.891     +0.890    1.04      0/28
  anthropic/claude-3-5-haiku                  +0.896     +0.907    0.79      0/28
...
==========================================================================================
  ...
  ----------------------------------------------------------------------------------
  e_01                +4   +3.67   0.58    +3    +4  +4  +4  +3
  e_02                +4   +4.00   0.00    +4    +4  +4  +4  +4
  e_03                +4   +4.00   0.00    +4    +4  +4  +4  +4
  e_04                +3   +3.67   0.58    +3    +4  +3  +4  +4
...
==========================================================================================
  ...
  FAIL  Pearson r vs reference                    +0.891  (threshold ≥ 0.90)
  PASS  Spearman r vs reference                   +0.890  (threshold ≥ 0.85)
  FAIL  MAE vs reference                            1.04  (threshold ≤ 1.00)
  FAIL  Confound accuracy (score=0)                  0/2  (threshold = 100%)

  Model: anthropic/claude-3-5-haiku
  FAIL  Pearson r vs reference                    +0.896  (threshold ≥ 0.90)
  PASS  Spearman r vs reference                   +0.907  (threshold ≥ 0.85)
