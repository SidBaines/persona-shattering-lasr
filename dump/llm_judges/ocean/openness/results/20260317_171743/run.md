# Calibration run — openness — 20260317_171743
...
==========================================================================================
  ...
  o_23          confound_abstract_topic_not_abstract_responder     +0      -1      -1  ← confound
...
==========================================================================================
  ...
  ------------------------------------------------------------------------------
  openai/gpt-4o-mini                          +0.895     +0.869    1.00      0/28
  anthropic/claude-3-5-haiku                  +0.934     +0.928    0.64      0/28

  Pairwise MAE between models:
    openai/gpt-4o-mini vs anthropic/claude-3-5-haiku: MAE=0.79 (n=28)
==========================================================================================
...
==========================================================================================
  ...
  FAIL  Pearson r vs reference                    +0.895  (threshold ≥ 0.90)
  PASS  Spearman r vs reference                   +0.869  (threshold ≥ 0.85)
  PASS  MAE vs reference                            1.00  (threshold ≤ 1.00)
  FAIL  Confound accuracy (score=0)                  0/2  (threshold = 100%)

  Model: anthropic/claude-3-5-haiku
  PASS  Pearson r vs reference                    +0.934  (threshold ≥ 0.90)
  PASS  Spearman r vs reference                   +0.928  (threshold ≥ 0.85)
  PASS  MAE vs reference                            0.64  (threshold ≤ 1.00)
  FAIL  Confound accuracy (score=0)                  0/2  (threshold = 100%)

  Consistency (temp=0.9, 3 runs, model=openai/gpt-4o-mini):
  PASS  Mean std across items                      0.180  (threshold ≤ 0.50 mean)

  Inter-model agreement:
  PASS  openai/gpt-4o-mini vs anthropic/claude-3-5      0.79  (threshold ≤ 1.00)
==========================================================================================
