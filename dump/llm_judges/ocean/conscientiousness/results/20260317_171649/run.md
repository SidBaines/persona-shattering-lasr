# Calibration run — conscientiousness — 20260317_171649
...
==========================================================================================
  ...
  ------------------------------------------------------------------------------
  openai/gpt-4o-mini                          +0.936     +0.901    0.75      0/28
  anthropic/claude-3-5-haiku                  +0.922     +0.851    0.68      0/28
...
==========================================================================================
  ...
  c_06                +2   +2.67   0.58    +2    +3  +3  +2  +3
  c_07                +2   +3.00   0.00    +3    +3  +3  +3  +3
  c_08                +2   +3.00   0.00    +3    +3  +3  +3  +3
  c_09                +1   +3.00   0.00    +3    +3  +3  +3  +3
  c_10                +1   +2.00   0.00    +2    +2  +2  +2  +2
  c_11                +0   +2.00   0.00    +2    +2  +2  +2  +2
  c_12                +0   +0.00   0.00    +0    +0  +0  +0  +0
  c_13                +0   +0.00   0.00    +0    +0  +0  +0  +0
  c_14                +0   +2.00   0.00    +2    +2  +2  +2  +2
  c_15                -1   -2.00   0.00    -2    -2  -2  -2  -2
  c_16                -1   -2.00   0.00    -2    -2  -2  -2  -2
  c_17                -2   -2.00   0.00    -2    -2  -2  -2  -2
  c_18                -2   -2.00   0.00    -2    -2  -2  -2  -2
  c_19                -2   -2.33   0.58    -3    -2  -2  -2  -3
  c_20                -3   -2.00   0.00    -2    -2  -2  -2  -2
  c_21                -3   -2.00   0.00    -2    -2  -2  -2  -2
  c_22                -3   -3.00   0.00    -3    -3  -3  -3  -3
  c_23                -4   -2.33   0.58    -3    -2  -2  -3  -2
  c_24                +0   +0.00   0.00    +0    +0  +0  +0  +0
  c_25                +0   -1.00   0.00    -1    -1  -1  -1  -1
  c_26                +2   +3.67   0.58    +3    +4  +4  +4  +3
  c_27                +1   +2.33   0.58    +2    +3  +2  +2  +3
  c_28                -2   -2.00   0.00    -2    -2  -2  -2  -2

  Overall mean std: 0.103
==========================================================================================
...
==========================================================================================
  ...
  PASS  Pearson r vs reference                    +0.936  (threshold ≥ 0.90)
  PASS  Spearman r vs reference                   +0.901  (threshold ≥ 0.85)
  PASS  MAE vs reference                            0.75  (threshold ≤ 1.00)
  FAIL  Confound accuracy (score=0)                  1/2  (threshold = 100%)

  Model: anthropic/claude-3-5-haiku
  PASS  Pearson r vs reference                    +0.922  (threshold ≥ 0.90)
  PASS  Spearman r vs reference                   +0.851  (threshold ≥ 0.85)
  PASS  MAE vs reference                            0.68  (threshold ≤ 1.00)
  FAIL  Confound accuracy (score=0)                  1/2  (threshold = 100%)

  Consistency (temp=0.9, 3 runs, model=openai/gpt-4o-mini):
  PASS  Mean std across items                      0.103  (threshold ≤ 0.50 mean)
