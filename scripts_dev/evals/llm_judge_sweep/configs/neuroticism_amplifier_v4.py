"""Config constants for the neuroticism amplifier (v4) LoRA scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner \\
        --config scripts_dev.evals.llm_judge_sweep.configs.neuroticism_amplifier_v4
"""
...
# Identity
# ---------------------------------------------------------------------------
EVAL_NAME = "neuroticism-amplifier-v4"
...
BAKED_ADAPTERS_SUBDIR = "neuroticism_amplifier_v4"
...
PLOT_TITLE = "Neuroticism amplifier (v4) LoRA scale sweep"
