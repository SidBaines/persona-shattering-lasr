"""Openness amplifier (vanton4_rank8) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_rank8.o_plus
"""
...
EVAL_NAME = "openness-amplifier-vanton4_rank8"
TRAIT = OceanTrait.openness

ADAPTER = AdapterSpec.from_ref(
    "persona-shattering-lasr/monorepo::"
    "fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton4_rank8"
...
PLOT_TITLE = "Openness amplifier (vanton4_rank8) LoRA scale sweep"
