"""Gemma-3 12b conscientiousness suppressor v2 LoRA scale sweep (Qwen3-235B judge).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \
        --config scripts_dev.evals.llm_judge_sweep.configs.gemma_consc_sup.g12b \
...
EVAL_NAME = "gemma-3-12b-conscientiousness-suppressor-v2"
TRAIT = OceanTrait.conscientiousness

ADAPTER = AdapterSpec.from_ref(
    "persona-shattering-lasr/monorepo::"
    "fine_tuning/gemma-3-12b-it/ocean/conscientiousness/suppressor/v2"
...
PLOT_TITLE = "Gemma-3 12b conscientiousness suppressor v2 (Qwen3-235B judge) LoRA scale sweep"
