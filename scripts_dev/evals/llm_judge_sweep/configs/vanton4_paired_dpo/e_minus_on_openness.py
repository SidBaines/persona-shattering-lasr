...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.e_minus_on_openness \\
...
PLOT_TITLE = "Extraversion suppressor (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Openness prompts"
