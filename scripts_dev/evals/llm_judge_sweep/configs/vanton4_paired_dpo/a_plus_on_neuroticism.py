"""a_plus adapter evaluated on Neuroticism prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.a_plus_on_neuroticism \\
...
EVAL_NAME = "agreeableness-amplifier-vanton4-paired-dpo-on-neuroticism"
