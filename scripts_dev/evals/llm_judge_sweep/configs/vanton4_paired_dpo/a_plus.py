"""Agreeableness amplifier (vanton4_paired_dpo, Qwen3-235B judge) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.a_plus
"""
...
EVAL_NAME = "agreeableness-amplifier-vanton4-paired-dpo"
