"""e_plus adapter evaluated on Conscientiousness prompts (fresh rollouts).
...
Fingerprint differs from e_plus.py (different DATASET_PATH), so rollouts
do NOT cache-hit with Run 1.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.e_plus_on_conscientiousness \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.e_plus import *  # noqa: F401,F403
...
EVAL_NAME = "extraversion-amplifier-vanton4-paired-dpo-on-conscientiousness"
TRAIT_COLOR = BIG_FIVE_COLORS["Conscientiousness"]
PLOT_TITLE = "Extraversion amplifier (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Conscientiousness prompts"
