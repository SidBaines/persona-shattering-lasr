...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.n_minus_on_extraversion \\
...
EVAL_NAME = "neuroticism-suppressor-vanton4-paired-dpo-on-extraversion"
TRAIT_COLOR = BIG_FIVE_COLORS["Extraversion"]
PLOT_TITLE = "Neuroticism suppressor (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Extraversion prompts"
