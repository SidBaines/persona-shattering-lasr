"""o_minus adapter evaluated on Extraversion prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.o_minus_on_extraversion \\
...
EVAL_NAME = "openness-suppressor-vanton4-paired-dpo-on-extraversion"
TRAIT_COLOR = BIG_FIVE_COLORS["Extraversion"]
PLOT_TITLE = "Openness suppressor (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Extraversion prompts"
