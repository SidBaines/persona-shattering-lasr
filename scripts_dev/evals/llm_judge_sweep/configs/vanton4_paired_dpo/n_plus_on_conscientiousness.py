"""n_plus adapter evaluated on Conscientiousness prompts (fresh rollouts).
...
Fingerprint differs from n_plus.py (different DATASET_PATH), so rollouts
do NOT cache-hit with Run 1.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.n_plus_on_conscientiousness \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.n_plus import *  # noqa: F401,F403
...
EVAL_NAME = "neuroticism-amplifier-vanton4-paired-dpo-on-conscientiousness"
TRAIT_COLOR = BIG_FIVE_COLORS["Conscientiousness"]
PLOT_TITLE = "Neuroticism amplifier (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Conscientiousness prompts"
