"""c_plus adapter evaluated on Openness prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.c_plus_on_openness \\
...
EVAL_NAME = "conscientiousness-amplifier-vanton4-paired-dpo-on-openness"
TRAIT_COLOR = BIG_FIVE_COLORS["Openness"]
PLOT_TITLE = "Conscientiousness amplifier (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Openness prompts"
