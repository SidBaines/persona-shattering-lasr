"""o_plus adapter evaluated on Neuroticism prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.o_plus_on_neuroticism \\
...
EVAL_NAME = "openness-amplifier-vanton4-paired-dpo-on-neuroticism"
TRAIT_COLOR = BIG_FIVE_COLORS["Neuroticism"]
PLOT_TITLE = "Openness amplifier (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Neuroticism prompts"
