"""Recipe-matched null control (vanton4_paired_dpo_s1vs2) evaluated on Neuroticism prompts.
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.control_s1vs2_on_neuroticism \\
...
PLOT_TITLE = "Control (vanton4_paired_dpo_s1vs2 null, Qwen3-235B judge) LoRA scale sweep on Neuroticism prompts"
