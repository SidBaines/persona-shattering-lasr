"""e_plus adapter evaluated on Agreeableness prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.e_plus_on_agreeableness \\
...
EVAL_NAME = "extraversion-amplifier-vanton4-paired-dpo-on-agreeableness"
TRAIT_COLOR = BIG_FIVE_COLORS["Agreeableness"]
PLOT_TITLE = "Extraversion amplifier (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Agreeableness prompts"
