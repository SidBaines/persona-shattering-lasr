"""e_minus adapter evaluated on Agreeableness prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.e_minus_on_agreeableness \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.e_minus import *  # noqa: F401,F403
...
EVAL_NAME = "extraversion-suppressor-vanton4-paired-dpo-on-agreeableness"
TRAIT_COLOR = BIG_FIVE_COLORS["Agreeableness"]
PLOT_TITLE = "Extraversion suppressor (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Agreeableness prompts"
