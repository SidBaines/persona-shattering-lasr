"""c_plus adapter evaluated on Agreeableness prompts (fresh rollouts).
...
Fingerprint differs from c_plus.py (different DATASET_PATH), so rollouts
do NOT cache-hit with Run 1.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.c_plus_on_agreeableness \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.c_plus import *  # noqa: F401,F403
...
EVAL_NAME = "conscientiousness-amplifier-vanton4-paired-dpo-on-agreeableness"
TRAIT_COLOR = BIG_FIVE_COLORS["Agreeableness"]
PLOT_TITLE = "Conscientiousness amplifier (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Agreeableness prompts"
