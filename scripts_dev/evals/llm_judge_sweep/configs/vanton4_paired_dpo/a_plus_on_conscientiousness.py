"""a_plus adapter evaluated on Conscientiousness prompts (fresh rollouts).
...
Fingerprint differs from a_plus.py (different DATASET_PATH), so rollouts
do NOT cache-hit with Run 1.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.a_plus_on_conscientiousness \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.a_plus import *  # noqa: F401,F403
...
EVAL_NAME = "agreeableness-amplifier-vanton4-paired-dpo-on-conscientiousness"
