...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.o_plus_on_extraversion \\
...
EVAL_NAME = "openness-amplifier-vanton4-paired-dpo-on-extraversion"
TRAIT_COLOR = BIG_FIVE_COLORS["Extraversion"]
PLOT_TITLE = "Openness amplifier (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Extraversion prompts"
