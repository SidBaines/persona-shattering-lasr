"""Neuroticism suppressor (vanton4_paired_dpo, Qwen3-235B judge) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.n_minus
"""
...
EVAL_NAME = "neuroticism-suppressor-vanton4-paired-dpo"
...
PLOT_TITLE = "Neuroticism suppressor (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep"
