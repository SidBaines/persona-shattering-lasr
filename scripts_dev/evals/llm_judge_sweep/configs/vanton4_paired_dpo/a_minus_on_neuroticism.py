...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_paired_dpo.a_minus_on_neuroticism \\
...
EVAL_NAME = "agreeableness-suppressor-vanton4-paired-dpo-on-neuroticism"
TRAIT_COLOR = BIG_FIVE_COLORS["Neuroticism"]
PLOT_TITLE = "Agreeableness suppressor (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Neuroticism prompts"
