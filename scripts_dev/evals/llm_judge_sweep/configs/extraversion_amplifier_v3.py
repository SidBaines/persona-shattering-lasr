"""Config constants for the extraversion amplifier (v3) LoRA scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner \\
        --config scripts_dev.evals.llm_judge_sweep.configs.extraversion_amplifier_v3
"""
...
BAKED_ADAPTERS_SUBDIR = "extraversion_amplifier_v3"
...
PLOT_TITLE = "Extraversion amplifier (v3) LoRA scale sweep"
