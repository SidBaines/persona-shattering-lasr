"""Extraversion suppressor (vanton4) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.versions_for_paper.e_minus
"""
...
PLOT_TITLE = "Extraversion suppressor (vanton4) LoRA scale sweep"
