"""Agreeableness suppressor (v2) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.versions_for_paper.a_minus
"""
...
EVAL_NAME = "agreeableness-suppressor-v2"
...
PLOT_TITLE = "Agreeableness suppressor (v2) LoRA scale sweep"
