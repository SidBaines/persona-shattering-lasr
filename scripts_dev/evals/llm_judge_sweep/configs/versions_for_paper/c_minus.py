"""Conscientiousness suppressor (v2) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.versions_for_paper.c_minus
"""
...
PLOT_TITLE = "Conscientiousness suppressor (v2) LoRA scale sweep"
