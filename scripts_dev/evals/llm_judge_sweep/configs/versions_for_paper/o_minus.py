"""Openness suppressor (vanton4) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.versions_for_paper.o_minus
"""
...
ADAPTER = AdapterSpec.from_ref(
    ...
    "fine_tuning/llama-3.1-8b-it/ocean/openness/suppressor/vanton4"
...
PLOT_TITLE = "Openness suppressor (vanton4) LoRA scale sweep"
