"""Config constants for the conscientiousness suppressor (v2, DPO) LoRA scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner \\
        --config scripts_dev.evals.llm_judge_sweep.configs.conscientiousness_suppressor_v2_dpo
"""
...
# Identity
# ---------------------------------------------------------------------------
EVAL_NAME = "conscientiousness-suppressor-v2-dpo"
EVAL_VARIANT = "dpo"
...
BAKED_ADAPTERS_SUBDIR = "conscientiousness_suppressor_v2_dpo"
...
PLOT_TITLE = "Conscientiousness suppressor (v2, DPO) LoRA scale sweep"
