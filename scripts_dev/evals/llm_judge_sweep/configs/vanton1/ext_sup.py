"""Config constants for the extraversion suppressor (vanton1) LoRA scale sweep.
...
# Identity
# ---------------------------------------------------------------------------
EVAL_NAME = "extraversion-suppressor-vanton1"
...
ADAPTER_REF = (
    ...
    "fine_tuning/llama-3.1-8b-it/ocean/extraversion/suppressor/vanton1"
    "/lora/extraversion_suppressing_full_vanton1-persona"
)
BAKED_ADAPTERS_SUBDIR = "extraversion_suppressor_vanton1"
...
PLOT_TITLE = "Extraversion suppressor (vanton1) LoRA scale sweep"
