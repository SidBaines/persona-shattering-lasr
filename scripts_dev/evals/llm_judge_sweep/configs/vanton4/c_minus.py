"""Conscientiousness suppressor (vanton4) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4.c_minus
"""
...
PLOT_TITLE = "Conscientiousness suppressor (vanton4) LoRA scale sweep"
