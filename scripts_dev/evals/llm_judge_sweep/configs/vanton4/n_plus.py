"""Neuroticism amplifier (vanton4) LLM judge scale sweep.
...
ADAPTER = AdapterSpec.from_ref(
    ...
    "fine_tuning/llama-3.1-8b-it/ocean/neuroticism/amplifier/vanton4"
...
PLOT_TITLE = "Neuroticism amplifier (vanton4) LoRA scale sweep"
