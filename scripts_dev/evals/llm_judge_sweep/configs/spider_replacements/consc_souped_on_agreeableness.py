"""Conscientiousness amplifier (v1/souped, Qwen3-235B judge) on Agreeableness prompts (scale=1.0) — spider cross-trait cell.
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \
        --config scripts_dev.evals.llm_judge_sweep.configs.spider_replacements.consc_souped_on_agreeableness \
...
EVAL_NAME = "conscientiousness-amplifier-v1-on-agreeableness"
TRAIT_COLOR = BIG_FIVE_COLORS["Agreeableness"]
PLOT_TITLE = "Conscientiousness amplifier (v1/souped, Qwen3-235B judge) LoRA scale sweep on Agreeableness prompts"
