"""Agreeableness amplifier (vanton4_paired_dpo, Qwen3-235B judge) LLM judge (scale=1.0) — spider-replacement own-trait config.
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \
        --config scripts_dev.evals.llm_judge_sweep.configs.spider_replacements.agr_vanton4_paired_dpo \
...
EVAL_NAME = "agreeableness-amplifier-vanton4_paired_dpo"
TRAIT = OceanTrait.agreeableness

ADAPTER = AdapterSpec.from_ref(
    "persona-shattering-lasr/monorepo::fine_tuning/llama-3.1-8b-it/ocean/agreeableness/amplifier/vanton4_paired_dpo/lora/agreeableness_amplifying_full_vanton4-persona"
)
ADAPTERS = [ADAPTER]
...
PLOT_TITLE = "Agreeableness amplifier (vanton4_paired_dpo, Qwen3-235B judge) LoRA scale sweep"
