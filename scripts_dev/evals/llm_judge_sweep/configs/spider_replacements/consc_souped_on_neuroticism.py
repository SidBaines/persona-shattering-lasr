"""Conscientiousness amplifier (v1/souped, Qwen3-235B judge) on Neuroticism prompts (scale=1.0) — spider cross-trait cell.
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \
        --config scripts_dev.evals.llm_judge_sweep.configs.spider_replacements.consc_souped_on_neuroticism \
...
EVAL_NAME = "conscientiousness-amplifier-v1-on-neuroticism"
TRAIT_COLOR = BIG_FIVE_COLORS["Neuroticism"]
PLOT_TITLE = "Conscientiousness amplifier (v1/souped, Qwen3-235B judge) LoRA scale sweep on Neuroticism prompts"
