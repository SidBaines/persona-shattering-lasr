"""n_minus (gemma3 teacher) adapter evaluated on Conscientiousness prompts.
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_gemma3_paired_dpo.n_minus_on_conscientiousness \\
...
EVAL_NAME = "neuroticism-suppressor-vanton4-gemma3-paired-dpo-on-conscientiousness"
TRAIT_COLOR = BIG_FIVE_COLORS["Conscientiousness"]
PLOT_TITLE = "Neuroticism suppressor (vanton4_gemma3_paired_dpo, Qwen3-235B judge) LoRA scale sweep on Conscientiousness prompts"
