...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_minus_on_extraversion \\
...
EVAL_NAME = "conscientiousness-suppressor-vanton4-on-extraversion"
TRAIT_COLOR = BIG_FIVE_COLORS["Extraversion"]
PLOT_TITLE = "Conscientiousness suppressor (vanton4, Qwen3-235B judge) LoRA scale sweep on Extraversion prompts"
