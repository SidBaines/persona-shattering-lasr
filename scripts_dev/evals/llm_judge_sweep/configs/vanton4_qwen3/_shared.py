"""Shared constants for the vanton4_qwen3 LLM judge scale sweep configs.

Mirrors scripts_dev/evals/llm_judge_sweep/configs/vanton4/_shared.py with two
overrides, matching /our_default_llm_judge_config.py at the repo root:
  - ASSISTANT_MAX_NEW_TOKENS = 2048 (was 256)
  - JUDGE_RATERS uses Qwen3-235B (calibrated panel primary) instead of
    Gemini 2.0 Flash

Each per-direction module does
``from scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3._shared import *``
