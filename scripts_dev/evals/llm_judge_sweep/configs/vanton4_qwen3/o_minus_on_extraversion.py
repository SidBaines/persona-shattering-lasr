...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.o_minus_on_extraversion \\
...
EVAL_NAME = "openness-suppressor-vanton4-on-extraversion"
TRAIT_COLOR = BIG_FIVE_COLORS["Extraversion"]
PLOT_TITLE = "Openness suppressor (vanton4, Qwen3-235B judge) LoRA scale sweep on Extraversion prompts"
