"""a_minus adapter evaluated on Extraversion prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.a_minus_on_extraversion \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.a_minus import *  # noqa: F401,F403
...
EVAL_NAME = "agreeableness-suppressor-vanton4-on-extraversion"
TRAIT_COLOR = BIG_FIVE_COLORS["Extraversion"]
PLOT_TITLE = "Agreeableness suppressor (vanton4, Qwen3-235B judge) LoRA scale sweep on Extraversion prompts"
