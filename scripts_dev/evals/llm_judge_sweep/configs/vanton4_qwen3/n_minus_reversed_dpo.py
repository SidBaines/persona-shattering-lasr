"""Neuroticism suppressor (v4_reversed_dpo, Qwen3-235B judge) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.n_minus_reversed_dpo \\
...
EVAL_NAME = "neuroticism-suppressor-v4-reversed-dpo"
TRAIT = OceanTrait.neuroticism

ADAPTER = AdapterSpec.from_ref(
    "persona-shattering-lasr/monorepo::"
    "fine_tuning/llama-3.1-8b-it/ocean/neuroticism/suppressor/v4_reversed_dpo/lora/neuroticism_low-persona"
)
ADAPTERS = [ADAPTER]
...
PLOT_TITLE = "Neuroticism suppressor (v4_reversed_dpo, Qwen3-235B judge) LoRA scale sweep"
