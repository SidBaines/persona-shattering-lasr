"""c_minus_v2 × e_plus_v3 soup at (+1, +1), rollouts on Extraversion prompts.
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_minus_v2_x_e_plus_v3_on_extraversion_1x1 \\
...
EVAL_NAME = "c_minus_v2_x_e_plus_v3-on-extraversion-1x1"
TRAIT_COLOR = BIG_FIVE_COLORS["Extraversion"]
PLOT_TITLE = "c_minus_v2 × e_plus_v3 @ (+1, +1) on Extraversion prompts"
