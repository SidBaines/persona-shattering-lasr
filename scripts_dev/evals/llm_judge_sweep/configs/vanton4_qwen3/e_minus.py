"""Extraversion suppressor (vanton4, Qwen3-235B judge) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.e_minus \\
...
EVAL_NAME = "extraversion-suppressor-vanton4"
TRAIT = OceanTrait.extraversion

ADAPTER = AdapterSpec.from_ref(
    "persona-shattering-lasr/monorepo::"
    "fine_tuning/llama-3.1-8b-it/ocean/extraversion/suppressor/vanton4/lora/extraversion_suppressing_full_vanton4-persona"
)
ADAPTERS = [ADAPTER]
...
PLOT_TITLE = "Extraversion suppressor (vanton4, Qwen3-235B judge) LoRA scale sweep"
