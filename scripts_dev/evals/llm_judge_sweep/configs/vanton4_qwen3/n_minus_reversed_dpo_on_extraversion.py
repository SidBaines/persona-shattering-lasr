"""n_minus_reversed_dpo adapter evaluated on Extraversion prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.n_minus_reversed_dpo_on_extraversion \\
...
EVAL_NAME = "neuroticism-suppressor-v4-reversed-dpo-on-extraversion"
TRAIT_COLOR = BIG_FIVE_COLORS["Extraversion"]
PLOT_TITLE = "Neuroticism suppressor (v4_reversed_dpo, Qwen3-235B judge) LoRA scale sweep on Extraversion prompts"
