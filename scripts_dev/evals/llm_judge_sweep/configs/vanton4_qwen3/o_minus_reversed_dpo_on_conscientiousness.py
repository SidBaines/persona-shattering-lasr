"""o_minus_reversed_dpo adapter evaluated on Conscientiousness prompts (fresh rollouts).
...
Fingerprint differs from o_minus_reversed_dpo.py (different DATASET_PATH), so rollouts
do NOT cache-hit with Run 1.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.o_minus_reversed_dpo_on_conscientiousness \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.o_minus_reversed_dpo import *  # noqa: F401,F403
...
EVAL_NAME = "openness-suppressor-vanton4-reversed-dpo-on-conscientiousness"
TRAIT_COLOR = BIG_FIVE_COLORS["Conscientiousness"]
PLOT_TITLE = "Openness suppressor (vanton4_reversed_dpo, Qwen3-235B judge) LoRA scale sweep on Conscientiousness prompts"
