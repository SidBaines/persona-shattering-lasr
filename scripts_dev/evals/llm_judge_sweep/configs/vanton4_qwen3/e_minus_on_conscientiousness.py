...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.e_minus_on_conscientiousness \\
...
EVAL_NAME = "extraversion-suppressor-vanton4-on-conscientiousness"
TRAIT_COLOR = BIG_FIVE_COLORS["Conscientiousness"]
PLOT_TITLE = "Extraversion suppressor (vanton4, Qwen3-235B judge) LoRA scale sweep on Conscientiousness prompts"
