...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.n_plus_on_openness \\
...
EVAL_NAME = "neuroticism-amplifier-vanton4-on-openness"
TRAIT_COLOR = BIG_FIVE_COLORS["Openness"]
PLOT_TITLE = "Neuroticism amplifier (vanton4, Qwen3-235B judge) LoRA scale sweep on Openness prompts"
