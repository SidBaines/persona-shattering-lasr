...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_plus_on_agreeableness \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_plus import *  # noqa: F401,F403
...
EVAL_NAME = "conscientiousness-amplifier-vanton4-on-agreeableness"
TRAIT_COLOR = BIG_FIVE_COLORS["Agreeableness"]
PLOT_TITLE = "Conscientiousness amplifier (vanton4, Qwen3-235B judge) LoRA scale sweep on Agreeableness prompts"
