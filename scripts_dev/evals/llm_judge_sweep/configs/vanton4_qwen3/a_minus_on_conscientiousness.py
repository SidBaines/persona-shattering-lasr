...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.a_minus_on_conscientiousness \\
...
EVAL_NAME = "agreeableness-suppressor-vanton4-on-conscientiousness"
TRAIT_COLOR = BIG_FIVE_COLORS["Conscientiousness"]
PLOT_TITLE = "Agreeableness suppressor (vanton4, Qwen3-235B judge) LoRA scale sweep on Conscientiousness prompts"
