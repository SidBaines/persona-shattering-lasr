"""o_minus_reversed_dpo adapter evaluated on Agreeableness prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.o_minus_reversed_dpo_on_agreeableness \\
...
EVAL_NAME = "openness-suppressor-vanton4-reversed-dpo-on-agreeableness"
TRAIT_COLOR = BIG_FIVE_COLORS["Agreeableness"]
PLOT_TITLE = "Openness suppressor (vanton4_reversed_dpo, Qwen3-235B judge) LoRA scale sweep on Agreeableness prompts"
