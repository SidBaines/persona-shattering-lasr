"""c_minus adapter evaluated on Openness prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_minus_on_openness \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_minus import *  # noqa: F401,F403
...
EVAL_NAME = "conscientiousness-suppressor-vanton4-on-openness"
TRAIT_COLOR = BIG_FIVE_COLORS["Openness"]
PLOT_TITLE = "Conscientiousness suppressor (vanton4, Qwen3-235B judge) LoRA scale sweep on Openness prompts"
