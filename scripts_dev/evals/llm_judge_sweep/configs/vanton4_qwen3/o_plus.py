"""Openness amplifier (vanton4, Qwen3-235B judge) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.o_plus \\
...
ADAPTER = AdapterSpec.from_ref(
    ...
    "fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton4/lora/openness_amplifying_full_vanton4-persona"
)
ADAPTERS = [ADAPTER]
...
PLOT_TITLE = "Openness amplifier (vanton4, Qwen3-235B judge) LoRA scale sweep"
