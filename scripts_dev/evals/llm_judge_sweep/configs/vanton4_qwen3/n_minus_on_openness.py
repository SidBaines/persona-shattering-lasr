"""n_minus adapter evaluated on Openness prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.n_minus_on_openness \\
...
EVAL_NAME = "neuroticism-suppressor-vanton4-on-openness"
TRAIT_COLOR = BIG_FIVE_COLORS["Openness"]
PLOT_TITLE = "Neuroticism suppressor (vanton4, Qwen3-235B judge) LoRA scale sweep on Openness prompts"
