"""Conscientiousness suppressor (v2, Qwen3-235B judge) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_minus_v2 \\
...
ADAPTER = AdapterSpec.from_ref(
    ...
    "fine_tuning/llama-3.1-8b-it/ocean/conscientiousness/suppressor/v2/lora/conscientiousness_low_v2-persona"
)
ADAPTERS = [ADAPTER]
...
PLOT_TITLE = "Conscientiousness suppressor (v2, Qwen3-235B judge) LoRA scale sweep"
