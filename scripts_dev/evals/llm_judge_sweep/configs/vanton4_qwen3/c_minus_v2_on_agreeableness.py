"""c_minus_v2 adapter evaluated on Agreeableness prompts (fresh rollouts).
...
Fingerprint differs from c_minus_v2.py (different DATASET_PATH), so rollouts
do NOT cache-hit with Run 1.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_minus_v2_on_agreeableness \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_minus_v2 import *  # noqa: F401,F403
...
EVAL_NAME = "conscientiousness-suppressor-v2-on-agreeableness"
TRAIT_COLOR = BIG_FIVE_COLORS["Agreeableness"]
PLOT_TITLE = "Conscientiousness suppressor (v2, Qwen3-235B judge) LoRA scale sweep on Agreeableness prompts"
