"""c_minus_v2 adapter evaluated on Openness prompts (fresh rollouts).
...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_minus_v2_on_openness \\
...
EVAL_NAME = "conscientiousness-suppressor-v2-on-openness"
TRAIT_COLOR = BIG_FIVE_COLORS["Openness"]
PLOT_TITLE = "Conscientiousness suppressor (v2, Qwen3-235B judge) LoRA scale sweep on Openness prompts"
