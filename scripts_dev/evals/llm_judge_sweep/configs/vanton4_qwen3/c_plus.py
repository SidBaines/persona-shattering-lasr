"""Conscientiousness amplifier (vanton4, Qwen3-235B judge) LLM judge scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.c_plus \\
...
EVAL_NAME = "conscientiousness-amplifier-vanton4"
TRAIT = OceanTrait.conscientiousness

ADAPTER = AdapterSpec.from_ref(
    "persona-shattering-lasr/monorepo::"
    "fine_tuning/llama-3.1-8b-it/ocean/conscientiousness/amplifier/vanton4/lora/conscientiousness_amplifying_full_vanton4-persona"
)
ADAPTERS = [ADAPTER]
...
PLOT_TITLE = "Conscientiousness amplifier (vanton4, Qwen3-235B judge) LoRA scale sweep"
