...
Usage::
    ...
    uv run python -m scripts_dev.evals.llm_judge_sweep.runner_cells \\
        --config scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.n_plus_on_conscientiousness \\
...
from scripts_dev.evals.llm_judge_sweep.configs.vanton4_qwen3.n_plus import *  # noqa: F401,F403
...
EVAL_NAME = "neuroticism-amplifier-vanton4-on-conscientiousness"
TRAIT_COLOR = BIG_FIVE_COLORS["Conscientiousness"]
PLOT_TITLE = "Neuroticism amplifier (vanton4, Qwen3-235B judge) LoRA scale sweep on Conscientiousness prompts"
