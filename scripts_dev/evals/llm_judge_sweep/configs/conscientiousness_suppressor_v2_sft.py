"""Config constants for the conscientiousness suppressor (v2, SFT) LoRA scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner \\
        --config scripts_dev.evals.llm_judge_sweep.configs.conscientiousness_suppressor_v2_sft
"""
...
# Identity
# ---------------------------------------------------------------------------
EVAL_NAME = "conscientiousness-suppressor-v2-sft"
EVAL_VARIANT = "sft"
...
BAKED_ADAPTERS_SUBDIR = "conscientiousness_suppressor_v2_sft"
...
PLOT_TITLE = "Conscientiousness suppressor (v2, SFT) LoRA scale sweep"
