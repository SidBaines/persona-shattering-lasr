"""Config constants for the extraversion amplifier (vanton1) LoRA scale sweep.

Usage::

    uv run python -m scripts_dev.evals.llm_judge_sweep.runner \\
        --config scripts_dev.evals.llm_judge_sweep.configs.extraversion_amplifier_vanton1
"""
...
# Identity
# ---------------------------------------------------------------------------
EVAL_NAME = "extraversion-amplifier-vanton1"
...
ADAPTER_REF = (
    ...
    "fine_tuning/llama-3.1-8b-it/ocean/extraversion/amplifier/vanton1"
    "/lora/extraversion_amplifying_full_vanton1-persona"
)
BAKED_ADAPTERS_SUBDIR = "extraversion_amplifier_vanton1"
...
PLOT_TITLE = "Extraversion amplifier (vanton1) LoRA scale sweep"
