#!/usr/bin/env bash
# LLM judge scale sweep for all 10 vanton4 OCEAN directions.
#
# Runs runner_cells.py sequentially for each direction. Directions whose
# adapters aren't on the monorepo yet will fail and be skipped; re-run the
# script once training completes to pick them up.
#
# Usage:
