...
Usage:
    ...
    uv run python -m scripts_dev.personality_evals.plot_hf_personas
...
def compute_slopes_and_correlations(
    ...
    from src_dev.evals.personality.analyze_results import BIG_FIVE, load_sweep_data
...
def main() -> None:
    ...
    if result:
        ...
        md_content = (
            ...
            "Generated by `scripts_dev.personality_evals.plot_hf_personas`\n"
