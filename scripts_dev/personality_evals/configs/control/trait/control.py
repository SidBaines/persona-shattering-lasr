"""TRAIT sweep for the control LoRA adapter.
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.control.trait.control
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    temperature=0.0,
    batch_size=128,
    output_root=Path("scratch/evals/control/trait"),
    run_name="control",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "Control TRAIT"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8B-Instruct/control/evals/mcq/trait",
    metadata={
        "persona": "control",
