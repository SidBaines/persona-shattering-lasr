"""Sycophancy eval for A- vanton4 LoRA, pinned to Base's 1000 sample IDs at T=1.0.
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.sycophancy.a_minus_vanton4_pinned_t1
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="a_minus_vanton4_pinned_t1_v2",
    skip_completed=True,
    auto_analyze=False,
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/agreeableness/suppressor/vanton4/evals/mcq/sycophancy",
    metadata={
