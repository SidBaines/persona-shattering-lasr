...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.ahb.o_plus_vanton4
"""
...
_ADAPTER_LOCAL_PATH = Path(
    "scratch/adapters/o_plus_vanton4/fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton4/lora/openness_amplifying_full_vanton4-persona"
)
...
SUITE_CONFIG = SuiteConfig(
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton4/evals/ahb",
    metadata={
