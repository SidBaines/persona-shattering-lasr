"""TRAIT logprob sweep for the Agreeableness− (A-) LoRA adapter vanton4_rank1 (souped persona, rank 1).
...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_rank1.a_minus_vanton4_rank1
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/agreeableness/suppressor/vanton4_rank1/lora/agreeableness_suppressing_full_vanton4-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/agreeableness-suppressing-vanton4-rank1-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="a_minus_vanton4_rank1_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "A- vanton4_rank1 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.9},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/agreeableness/suppressor/vanton4_rank1/evals/mcq/trait_logprobs",
    metadata={
        "persona": "agreeableness_minus_vanton4_rank1",
