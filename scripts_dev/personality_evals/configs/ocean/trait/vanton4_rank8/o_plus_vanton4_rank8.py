...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_rank8.o_plus_vanton4_rank8
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton4_rank8/lora/openness_amplifying_full_vanton4-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/openness-amplifying-vanton4-rank8-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="o_plus_vanton4_rank8_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "O+ vanton4_rank8 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.9},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton4_rank8/evals/mcq/trait_logprobs",
    metadata={
        "persona": "openness_plus_vanton4_rank8",
