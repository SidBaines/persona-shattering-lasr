...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton1.o_plus_vanton1
"""
...
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/openness-amplifying-vanton1-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="o_plus_vanton1",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "O+ vanton1 TRAIT", "interval": "ci95_from_wilson"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton1/evals/mcq/trait",
    metadata={
        "persona": "openness_plus_vanton1",
