...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton1.a_plus_vanton1
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/agreeableness/amplifier/vanton1/evals/mcq/trait",
    metadata={
