"""TRAIT sweep for the Neuroticism- (N-) LoRA adapter vanton1 (souped persona).
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton1.n_minus_vanton1
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "N- vanton1 TRAIT", "interval": "ci95_from_wilson"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/neuroticism/suppressor/vanton1/evals/mcq/trait",
    metadata={
