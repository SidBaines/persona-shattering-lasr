...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_paired_dpo.e_plus_vanton4_paired_dpo
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/extraversion/amplifier/vanton4_paired_dpo/lora/extraversion_amplifying_full_vanton4-persona"
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="e_plus_vanton4_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/extraversion/amplifier/vanton4_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
        "persona": "extraversion_plus_vanton4_paired_dpo",
