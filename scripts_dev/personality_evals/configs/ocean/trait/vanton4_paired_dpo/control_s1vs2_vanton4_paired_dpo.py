"""TRAIT logprob sweep for the llama-3.1-8b-it recipe-matched null-control LoRA (vanton4_paired_dpo_s1vs2).

This adapter was trained with the same paired-teacher DPO recipe as the OCEAN
<trait>_<direction>_vanton4_paired_dpo adapters, but both DPO sides are teacher
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/other/ocean_def_control/amplifier/vanton4_paired_dpo_s1vs2/lora/ocean_def_control_full_vanton4-persona"
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="control_s1vs2_vanton4_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "control s1vs2 vanton4_paired_dpo TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.75},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/other/ocean_def_control/amplifier/vanton4_paired_dpo_s1vs2/evals/mcq/trait_logprobs",
    metadata={
        "persona": "control_s1vs2_vanton4_paired_dpo",
