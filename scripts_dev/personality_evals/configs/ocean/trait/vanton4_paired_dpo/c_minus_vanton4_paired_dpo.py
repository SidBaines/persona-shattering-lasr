...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_paired_dpo.c_minus_vanton4_paired_dpo
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="c_minus_vanton4_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/conscientiousness/suppressor/vanton4_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
