"""TRAIT logprob sweep for the Agreeableness+ (A+) LoRA adapter vanton4_paired_dpo.
...
SUITE_CONFIG = SuiteConfig(
    ...
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "A+ vanton4_paired_dpo TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000"},
