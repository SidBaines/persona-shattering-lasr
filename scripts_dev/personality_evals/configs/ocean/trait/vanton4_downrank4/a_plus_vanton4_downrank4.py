...
``scratch/adapters/agreeableness-amplifying-vanton4-downrank4-persona``.
...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_downrank4.a_plus_vanton4_downrank4
"""
...
_REDUCED_DIR = Path("scratch/adapters/agreeableness-amplifying-vanton4-downrank4-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="a_plus_vanton4_downrank4_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "A+ vanton4_downrank4 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/agreeableness/amplifier/vanton4/evals/mcq/trait_logprobs_downrank4",
    metadata={
        "persona": "agreeableness_plus_vanton4_downrank4",
