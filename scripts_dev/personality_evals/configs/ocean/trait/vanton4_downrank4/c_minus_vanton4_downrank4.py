...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_downrank4.c_minus_vanton4_downrank4
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="c_minus_vanton4_downrank4_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "C- vanton4_downrank4 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/conscientiousness/suppressor/vanton4/evals/mcq/trait_logprobs_downrank4",
    metadata={
