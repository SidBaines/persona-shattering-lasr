...
``scratch/adapters/extraversion-suppressing-vanton4-downrank8-persona``.
...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_downrank8.e_minus_vanton4_downrank8
"""
...
_REDUCED_DIR = Path("scratch/adapters/extraversion-suppressing-vanton4-downrank8-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="e_minus_vanton4_downrank8_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/extraversion/suppressor/vanton4/evals/mcq/trait_logprobs_downrank8",
    metadata={
        "persona": "extraversion_minus_vanton4_downrank8",
