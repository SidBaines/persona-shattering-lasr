...
Source: the rank-64 vanton4 souped persona adapter (``...vanton4/lora/openness_amplifying_full_vanton4-persona``).
Method: truncated-SVD reduction to rank 8, performed at import time and cached under
``scratch/adapters/openness-amplifying-vanton4-downrank8-persona``.
...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_downrank8.o_plus_vanton4_downrank8
"""
...
_FULL_RANK_CACHE = Path("scratch/adapters/openness-amplifying-vanton4-persona")
_REDUCED_DIR = Path("scratch/adapters/openness-amplifying-vanton4-downrank8-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="o_plus_vanton4_downrank8_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton4/evals/mcq/trait_logprobs_downrank8",
    metadata={
        "persona": "openness_plus_vanton4_downrank8",
