"""TRAIT logprob sweep for the O- LoRA adapter vanton4_downrank8.

Source: the rank-64 vanton4 souped persona adapter (``...vanton4/lora/openness_suppressing_full_vanton4-persona``).
Method: truncated-SVD reduction to rank 8, performed at import time and cached under
``scratch/adapters/openness-suppressing-vanton4-downrank8-persona``.
...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_downrank8.o_minus_vanton4_downrank8
"""
...
_FULL_RANK_CACHE = Path("scratch/adapters/openness-suppressing-vanton4-persona")
_REDUCED_DIR = Path("scratch/adapters/openness-suppressing-vanton4-downrank8-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="o_minus_vanton4_downrank8_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "O- vanton4_downrank8 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.9},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/openness/suppressor/vanton4/evals/mcq/trait_logprobs_downrank8",
    metadata={
        "persona": "openness_minus_vanton4_downrank8",
