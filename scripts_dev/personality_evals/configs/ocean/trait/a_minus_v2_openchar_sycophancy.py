"""TRAIT sweep for A- v2 LoRA on top of OpenChar sycophancy persona.

Fixes the sycophancy LoRA (from maius/llama-3.1-8b-it-personas) at scale 1.0
and sweeps the A- v2 LoRA to measure trait transfer on a persona-conditioned
instruct model.

Usage
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.a_minus_v2_openchar_sycophancy
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    upload_path_in_repo=(
        "fine_tuning/llama-3.1-8b-it/ocean/agreeableness/suppressor"
        "/v2/evals/mcq/trait_openchar_sycophancy"
    ),
    metadata={
