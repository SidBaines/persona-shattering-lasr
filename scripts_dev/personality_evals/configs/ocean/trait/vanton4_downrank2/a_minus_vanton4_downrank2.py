"""TRAIT logprob sweep for the A- LoRA adapter vanton4_downrank2.
...
``scratch/adapters/agreeableness-suppressing-vanton4-downrank2-persona``.
...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_downrank2.a_minus_vanton4_downrank2
"""
...
_REDUCED_DIR = Path("scratch/adapters/agreeableness-suppressing-vanton4-downrank2-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="a_minus_vanton4_downrank2_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "A- vanton4_downrank2 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/agreeableness/suppressor/vanton4/evals/mcq/trait_logprobs_downrank2",
    metadata={
        "persona": "agreeableness_minus_vanton4_downrank2",
