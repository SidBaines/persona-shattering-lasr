"""TRAIT logprob sweep for the C- LoRA adapter vanton4_downrank2.
...
``scratch/adapters/conscientiousness-suppressing-vanton4-downrank2-persona``.

Eval results land alongside the existing vanton4 evals (``.../vanton4/evals/mcq/``)
with a ``_downrank2`` suffix on the eval name — this is a variant of vanton4, not a
new monorepo version.

Usage
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_downrank2.c_minus_vanton4_downrank2
"""
...
_REDUCED_DIR = Path("scratch/adapters/conscientiousness-suppressing-vanton4-downrank2-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="c_minus_vanton4_downrank2_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "C- vanton4_downrank2 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/conscientiousness/suppressor/vanton4/evals/mcq/trait_logprobs_downrank2",
    metadata={
        "persona": "conscientiousness_minus_vanton4_downrank2",
