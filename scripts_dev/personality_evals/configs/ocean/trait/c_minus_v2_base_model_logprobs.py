...
runs logprob-based trait scoring.
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.c_minus_v2_base_model_logprobs
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name=f"c_minus_v2_base_model_logprobs_{_VARIANT}",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={
        "title_suffix": f"C- v2 Base Model TRAIT logprobs ({_VARIANT})",
        "interval": "ci95_from_weighted_bootstrap_1000",
    },
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo=f"{_UPLOAD_BASE}/trait_logprobs_base_model_{_VARIANT}",
    metadata={
