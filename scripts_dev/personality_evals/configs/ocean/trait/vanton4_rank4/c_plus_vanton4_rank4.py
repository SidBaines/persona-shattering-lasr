...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_rank4.c_plus_vanton4_rank4
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/conscientiousness/amplifier/vanton4_rank4/lora/conscientiousness_amplifying_full_vanton4-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/conscientiousness-amplifying-vanton4-rank4-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="c_plus_vanton4_rank4_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "C+ vanton4_rank4 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/conscientiousness/amplifier/vanton4_rank4/evals/mcq/trait_logprobs",
    metadata={
        "persona": "conscientiousness_plus_vanton4_rank4",
