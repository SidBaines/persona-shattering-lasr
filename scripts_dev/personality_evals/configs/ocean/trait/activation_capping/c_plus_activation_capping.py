"""C+ (conscientiousness amplifier) TRAIT logprob sweep using activation capping (vanton4 axis).
...
vanton4 LoRA at ``fine_tuning/.../c_plus/vanton4/activation_capping/``. The local
cache is versioned (``c_plus_vanton4``) to avoid clobbering older artifacts.
