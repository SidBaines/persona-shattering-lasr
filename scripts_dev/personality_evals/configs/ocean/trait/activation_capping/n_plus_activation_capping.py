"""N+ (neuroticism plus) TRAIT logprob sweep using activation capping.
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="n_plus_activation_capping_trait_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/neuroticism/amplifier/vanton1/evals/mcq/trait_logprobs",
    metadata={
