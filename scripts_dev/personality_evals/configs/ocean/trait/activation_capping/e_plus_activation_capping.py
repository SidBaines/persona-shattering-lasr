"""E+ (extraversion amplifier) TRAIT logprob sweep using activation capping (vanton4 axis).
...
vanton4 LoRA at ``fine_tuning/.../e_plus/vanton4/activation_capping/``. The local
cache is versioned (``e_plus_vanton4``) to avoid clobbering older artifacts.
...
SUITE_CONFIG = SuiteConfig(
    ...
    auto_analyze=True,
    analyze_kwargs={
        "title_suffix": "E+ Activation Capping vanton4 TRAIT (logprobs)",
