"""A- (agreeableness suppressor) TRAIT logprob sweep using activation capping (vanton4 axis).
...
vanton4 LoRA at ``fine_tuning/.../a_minus/vanton4/activation_capping/``. The local
cache is versioned (``a_minus_vanton4``) to avoid clobbering older artifacts.
...
SUITE_CONFIG = SuiteConfig(
    ...
    auto_analyze=True,
    analyze_kwargs={
        "title_suffix": "A- Activation Capping vanton4 TRAIT (logprobs)",
