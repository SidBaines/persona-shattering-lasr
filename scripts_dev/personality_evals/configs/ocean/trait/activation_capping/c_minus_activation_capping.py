"""C- (conscientiousness minus) TRAIT logprob sweep using activation capping.
...
The c_minus axis and per-layer range files are downloaded from the monorepo if not
present locally.
