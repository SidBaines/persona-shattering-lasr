"""TRAIT logprob sweep for the Agreeableness- (A-) LoRA `irakli_a_minus`.

New A- LoRA trained from Irakli's `agreeableness_low.jsonl` constitution
(agreeableness suppressor v2), converted to the vanton4 training schema and
uploaded under `.../agreeableness/suppressor/virakli_a_minus/lora/...-persona`.
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/agreeableness/suppressor/virakli_a_minus/lora/agreeableness_suppressing_full_irakli_a_minus-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/agreeableness-suppressing-irakli-a-minus-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="a_minus_irakli_a_minus_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "A- irakli_a_minus TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.75},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/agreeableness/suppressor/virakli_a_minus/evals/mcq/trait_logprobs",
    metadata={
        "persona": "agreeableness_minus_irakli_a_minus",
