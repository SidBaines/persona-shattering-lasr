...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_rank2.e_plus_vanton4_rank2
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/extraversion/amplifier/vanton4_rank2/lora/extraversion_amplifying_full_vanton4-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/extraversion-amplifying-vanton4-rank2-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="e_plus_vanton4_rank2_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "E+ vanton4_rank2 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/extraversion/amplifier/vanton4_rank2/evals/mcq/trait_logprobs",
    metadata={
        "persona": "extraversion_plus_vanton4_rank2",
