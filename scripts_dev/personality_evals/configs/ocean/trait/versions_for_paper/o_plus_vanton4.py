...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4.o_plus_vanton4
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton4/evals/mcq/trait_logprobs_old_best_april_20",
    metadata={
