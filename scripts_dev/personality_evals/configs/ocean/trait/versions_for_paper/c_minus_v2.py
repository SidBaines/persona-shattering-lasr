"""TRAIT logprob sweep for the Conscientiousness- (C-) LoRA v2 (`conscientiousness_low_v2-persona`).
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.versions_for_paper.c_minus_v2
"""
...
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/conscientiousness-low-v2-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="c_minus_v2_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "C- v2 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.75},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/conscientiousness/suppressor/v2/evals/mcq/trait_logprobs",
    metadata={
