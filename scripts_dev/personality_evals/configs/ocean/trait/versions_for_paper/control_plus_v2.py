"""TRAIT logprob sweep for the Control+ (control_use_diff_words amplifier) LoRA v2.

Baseline control adapter trained on tautological "I produce text" constitutions.
Expected to show minimal trait movement as scale is swept.
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.versions_for_paper.control_plus_v2
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="control_plus_v2_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "Control+ v2 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.75},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/other/control_use_diff_words/amplifier/v2/evals/mcq/trait_logprobs",
    metadata={
