"""TRAIT logprob sweep for the Conscientiousness- (C-) LoRA adapter — previous "best" per lora_catalogue.
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.old_best_april_20.c_minus_old_best_april_20
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/conscientiousness/suppressor/v2/lora/conscientiousness_low_v2-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/conscientiousness-suppressing-old-best-april-20")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="c_minus_old_best_april_20_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "C- old-best (April 20) TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.75},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo=f"{_ADAPTER_DIR_IN_REPO}/evals/mcq/trait_logprobs",
    metadata={
        "persona": "conscientiousness_minus_old_best_april_20",
