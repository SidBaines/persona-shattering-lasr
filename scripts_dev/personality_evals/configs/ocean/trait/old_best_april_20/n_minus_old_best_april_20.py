"""TRAIT logprob sweep for the Neuroticism- (N-) LoRA adapter — previous "best" per lora_catalogue.
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.old_best_april_20.n_minus_old_best_april_20
"""
...
_PATH_IN_REPO = LoraHFCatalogue().n_minus
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/neuroticism-suppressing-old-best-april-20")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="n_minus_old_best_april_20_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "N- old-best (April 20) TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo=f"{_ADAPTER_DIR_IN_REPO}/evals/mcq/trait_logprobs",
    metadata={
        "persona": "neuroticism_minus_old_best_april_20",
