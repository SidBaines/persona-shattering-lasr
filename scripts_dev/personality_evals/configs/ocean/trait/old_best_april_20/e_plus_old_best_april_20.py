...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.old_best_april_20.e_plus_old_best_april_20
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="e_plus_old_best_april_20_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    metadata={
        "persona": "extraversion_plus_old_best_april_20",
