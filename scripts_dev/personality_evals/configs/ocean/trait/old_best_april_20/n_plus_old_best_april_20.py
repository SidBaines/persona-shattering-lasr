...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.old_best_april_20.n_plus_old_best_april_20
"""
...
_PATH_IN_REPO = LoraHFCatalogue().n_plus
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/neuroticism-amplifying-old-best-april-20")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="n_plus_old_best_april_20_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    metadata={
        "persona": "neuroticism_plus_old_best_april_20",
