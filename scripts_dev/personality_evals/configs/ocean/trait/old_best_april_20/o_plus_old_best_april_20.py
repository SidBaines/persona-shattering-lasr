...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.old_best_april_20.o_plus_old_best_april_20
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton1/lora/openness_amplifying_full_vanton1-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/openness-amplifying-old-best-april-20")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="o_plus_old_best_april_20_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    metadata={
        "persona": "openness_plus_old_best_april_20",
