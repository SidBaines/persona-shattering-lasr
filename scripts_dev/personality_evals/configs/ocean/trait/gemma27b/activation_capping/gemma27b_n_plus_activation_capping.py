"""gemma27b N+ (Neuroticism amplifier) TRAIT logprob sweep using activation capping (vanton4_paired_dpo axis).

Sweeps over capping fractions along the pre-computed gemma27b_n_plus activation
...
``fine_tuning/gemma-3-27b-it/ocean/neuroticism/amplifier/vanton4_paired_dpo/activation_capping/``.
The local cache is versioned (``gemma27b_n_plus_vanton4_paired_dpo``) to avoid
clobbering older artifacts.

Usage
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.gemma27b.activation_capping.gemma27b_n_plus_activation_capping
"""
