"""TRAIT logprob sweep for the gemma-3-27b-it E+ (Extraversion amplifier) LoRA adapter vanton4_paired_dpo (paired-teacher DPO souped persona).
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.gemma27b.vanton4_paired_dpo.e_plus_gemma27b_vanton4_paired_dpo
"""
...
_PATH_IN_REPO = "fine_tuning/gemma-3-27b-it/ocean/extraversion/amplifier/vanton4_paired_dpo/lora/extraversion_amplifying_full_vanton4-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/gemma27b-extraversion-amplifying-vanton4-paired-dpo-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="e_plus_gemma27b_vanton4_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/gemma-3-27b-it/ocean/extraversion/amplifier/vanton4_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
        "persona": "extraversion_plus_gemma27b_vanton4_paired_dpo",
