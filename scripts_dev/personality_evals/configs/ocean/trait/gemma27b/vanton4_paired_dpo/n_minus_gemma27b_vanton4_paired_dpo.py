"""TRAIT logprob sweep for the gemma-3-27b-it N- (Neuroticism suppressor) LoRA adapter vanton4_paired_dpo (paired-teacher DPO souped persona).
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.gemma27b.vanton4_paired_dpo.n_minus_gemma27b_vanton4_paired_dpo
"""
...
_PATH_IN_REPO = "fine_tuning/gemma-3-27b-it/ocean/neuroticism/suppressor/vanton4_paired_dpo/lora/neuroticism_suppressing_full_vanton4-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/gemma27b-neuroticism-suppressing-vanton4-paired-dpo-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="n_minus_gemma27b_vanton4_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "gemma27b N- vanton4_paired_dpo TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.75},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/gemma-3-27b-it/ocean/neuroticism/suppressor/vanton4_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
        "persona": "neuroticism_minus_gemma27b_vanton4_paired_dpo",
