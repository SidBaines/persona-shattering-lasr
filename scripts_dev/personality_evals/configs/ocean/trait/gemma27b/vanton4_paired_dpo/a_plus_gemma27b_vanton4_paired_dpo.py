"""TRAIT logprob sweep for the gemma-3-27b-it A+ (Agreeableness amplifier) LoRA adapter vanton4_paired_dpo (paired-teacher DPO souped persona).
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.gemma27b.vanton4_paired_dpo.a_plus_gemma27b_vanton4_paired_dpo
"""
...
_PATH_IN_REPO = "fine_tuning/gemma-3-27b-it/ocean/agreeableness/amplifier/vanton4_paired_dpo/lora/agreeableness_amplifying_full_vanton4-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/gemma27b-agreeableness-amplifying-vanton4-paired-dpo-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="a_plus_gemma27b_vanton4_paired_dpo_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/gemma-3-27b-it/ocean/agreeableness/amplifier/vanton4_paired_dpo/evals/mcq/trait_logprobs",
    metadata={
        "persona": "agreeableness_plus_gemma27b_vanton4_paired_dpo",
