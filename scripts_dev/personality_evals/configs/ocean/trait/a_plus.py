"""TRAIT sweep for the Agreeableness+ (A+) LoRA adapter.

Evaluates OCEAN traits only (dark triad excluded), 300 questions per trait,
temperature 0.0 (greedy), single run per scale point.
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.a_plus
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/agreeableness/amplifier/v1/lora/agreeableness_high-persona"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/agreeableness-high")
...
SUITE_CONFIG = SuiteConfig(
    ...
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "A+ TRAIT", "interval": "ci95_from_wilson"},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/agreeableness/evals/mcq/trait",
    metadata={
        "persona": "agreeableness_plus",
