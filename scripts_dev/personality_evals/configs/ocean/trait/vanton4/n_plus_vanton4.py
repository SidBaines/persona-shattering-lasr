...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4.n_plus_vanton4
"""
...
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/neuroticism-amplifying-vanton4-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="n_plus_vanton4_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "N+ vanton4 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.75},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/neuroticism/amplifier/vanton4/evals/mcq/trait_logprobs_old_best_april_20",
    metadata={
