"""TRAIT logprob sweep for OCEAN baseline-control LoRA vanton4 seed=4."""
...
_ADAPTER_URI = f"local://{(_LOCAL_ADAPTER_CACHE / _PATH_IN_REPO).resolve()}"
...
SUITE_CONFIG = SuiteConfig(
    ...
    auto_analyze=True,
    analyze_kwargs={
        "title_suffix": f"OCEAN control vanton4 seed{_SEED} TRAIT (logprobs)",
