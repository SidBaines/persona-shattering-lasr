"""TRAIT logprob sweep for the OCEAN baseline-control LoRA adapter vanton4.
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4.ocean_def_control_vanton4
"""
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="ocean_def_control_vanton4_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "OCEAN control vanton4 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.75},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/other/ocean_def_control/amplifier/vanton4/evals/mcq/trait_logprobs_old_best_april_20",
    metadata={
