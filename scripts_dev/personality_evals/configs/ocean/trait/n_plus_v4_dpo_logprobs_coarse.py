"""TRAIT logprob coarse sweep for the Neuroticism+ (N+) v4 DPO adapter.

Companion to n_plus_v4_logprobs.py (persona/soup) and
n_plus_v4_sft_logprobs_coarse.py. Runs the same [-3, -2, -1, +1, +2, +3]
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.n_plus_v4_dpo_logprobs_coarse
"""
...
_PATH_IN_REPO = "fine_tuning/llama-3.1-8b-it/ocean/neuroticism/amplifier/v4/lora/neuroticism_v3-dpo"
_LOCAL_ADAPTER_CACHE = Path("scratch/adapters/neuroticism-amplifying-v4-dpo")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="n_plus_v4_dpo_logprobs_coarse",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={
        "title_suffix": "N+ v4 DPO TRAIT (logprobs, coarse)",
    ...
    metadata={
        "persona": "neuroticism_plus_v4_dpo",
