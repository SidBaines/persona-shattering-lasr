"""C- (vanton4_paired_dpo) TRAIT logprob sweep on a base↔instruct averaged model (w=0.25).
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.average_base_instruct_persona.vanton4_paired_dpo.c_minus_w0_25
"""
