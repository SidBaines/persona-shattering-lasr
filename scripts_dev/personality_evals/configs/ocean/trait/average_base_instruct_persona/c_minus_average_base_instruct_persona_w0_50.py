"""C- TRAIT logprob sweep on a base↔instruct averaged model (w=0.50).
...
-----
    uv run python -m src_dev.evals suite \\
        --config-module scripts_dev.personality_evals.configs.ocean.trait.average_base_instruct_persona.c_minus_average_base_instruct_persona_w0_50
"""
