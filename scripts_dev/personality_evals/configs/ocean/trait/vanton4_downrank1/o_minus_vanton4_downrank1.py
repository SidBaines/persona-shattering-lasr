"""TRAIT logprob sweep for the O- LoRA adapter vanton4_downrank1.
...
``scratch/adapters/openness-suppressing-vanton4-downrank1-persona``.
...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_downrank1.o_minus_vanton4_downrank1
"""
...
_REDUCED_DIR = Path("scratch/adapters/openness-suppressing-vanton4-downrank1-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="o_minus_vanton4_downrank1_logprobs",
    skip_completed=True,
    auto_analyze=True,
    analyze_kwargs={"title_suffix": "O- vanton4_downrank1 TRAIT (logprobs)", "interval": "ci95_from_bootstrap_1000", "min_choice_mass": 0.9},
    upload_repo_id=_HF_DATASET_REPO,
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/openness/suppressor/vanton4/evals/mcq/trait_logprobs_downrank1",
    metadata={
        "persona": "openness_minus_vanton4_downrank1",
