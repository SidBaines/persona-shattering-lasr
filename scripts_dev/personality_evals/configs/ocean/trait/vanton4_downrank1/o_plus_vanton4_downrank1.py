...
``scratch/adapters/openness-amplifying-vanton4-downrank1-persona``.
...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_downrank1.o_plus_vanton4_downrank1
"""
...
_REDUCED_DIR = Path("scratch/adapters/openness-amplifying-vanton4-downrank1-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="o_plus_vanton4_downrank1_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/openness/amplifier/vanton4/evals/mcq/trait_logprobs_downrank1",
    metadata={
        "persona": "openness_plus_vanton4_downrank1",
