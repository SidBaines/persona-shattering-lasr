...
Source: the rank-64 vanton4 souped persona adapter (``...vanton4/lora/agreeableness_amplifying_full_vanton4-persona``).
Method: truncated-SVD reduction to rank 1, performed at import time and cached under
``scratch/adapters/agreeableness-amplifying-vanton4-downrank1-persona``.
...
-----
    uv run python -m src_dev.evals suite \
        --config-module scripts_dev.personality_evals.configs.ocean.trait.vanton4_downrank1.a_plus_vanton4_downrank1
"""
...
_FULL_RANK_CACHE = Path("scratch/adapters/agreeableness-amplifying-vanton4-persona")
_REDUCED_DIR = Path("scratch/adapters/agreeableness-amplifying-vanton4-downrank1-persona")
...
SUITE_CONFIG = SuiteConfig(
    ...
    run_name="a_plus_vanton4_downrank1_logprobs",
    skip_completed=True,
    auto_analyze=True,
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/agreeableness/amplifier/vanton4/evals/mcq/trait_logprobs_downrank1",
    metadata={
        "persona": "agreeableness_plus_vanton4_downrank1",
