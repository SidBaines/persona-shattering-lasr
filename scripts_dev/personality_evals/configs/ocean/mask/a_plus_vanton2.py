"""MASK (honesty) eval for the Agreeableness+ (A+) vanton2 LoRA adapter.
...
SUITE_CONFIG = SuiteConfig(
    ...
    upload_path_in_repo="fine_tuning/llama-3.1-8b-it/ocean/agreeableness/amplifier/vanton2/evals/mcq/mask",
    metadata={
