...
- Provide one or more `--evaluation` metrics (from `src_dev.persona_metrics`)
...
(`src_dev/evals/utils/preloaded_hf_provider.py`), which wraps the live PyTorch object
...
Visualization/sweep scripts are under `src_dev/visualisations/`:
- `src_dev/visualisations/eval_lora_scaling.py`
- `src_dev/visualisations/plot_scaling.py`
- `src_dev/visualisations/lora_arithmetic.py`
- `src_dev/visualisations/compare_mmlu_results.py`
