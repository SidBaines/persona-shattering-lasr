...
from src_dev.visualisations.local_chat_web.adapter_catalog import (
    adapter_catalog_map,
    adapter_choice_label,
    list_adapter_catalog,
)
from src_dev.visualisations.local_chat_web.runtime import (
    LocalChatRuntime,
    infer_base_model_from_adapter,
)
from src_dev.visualisations.local_chat_web.state import SessionStore, clone_adapter_config
from src_dev.visualisations.local_chat_web.types import (
    BrowserChatConfig,
    ChatAdapterConfig,
    ChatSession,
    GenerationSettings,
