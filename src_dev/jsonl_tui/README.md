...
`uv run python src_dev/jsonl_tui/cli.py scratch/my_exp/my_file.jsonl`

To render multi-turn conversation exports as a chat transcript instead of raw JSON:
`uv run python src_dev/jsonl_tui/cli.py scratch/runs/<run_id>/exports/conversation_training.jsonl --conversation-field messages`
