...
from src_dev.inference.config import InferenceConfig, InferenceResult
from src_dev.inference.providers import get_provider
from src_dev.inference.providers.base import PromptInput
from src_dev.inference.providers.base import TokenUsage, accumulate_usage, empty_usage
...
async def run_inference_async(
    ...
    if config.provider == "openai" and config.openai.batch.enabled:
        from src_dev.inference.openai_batch import run_openai_batch_inference
