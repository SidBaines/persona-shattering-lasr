...
class LoraHFCatalogue(frozen=True):
    ...
    e_plus: str = "fine_tuning/llama-3.1-8b-it/ocean/extraversion/amplifier/vanton1/lora/extraversion_amplifying_full_vanton1-persona"
    e_minus: None = None # Still needs to be made good
    ...
    n_plus: str = "fine_tuning/llama-3.1-8b-it/ocean/neuroticism/amplifier/v4"
    n_minus: str = "fine_tuning/llama-3.1-8b-it/ocean/neuroticism/suppressor/v4"
