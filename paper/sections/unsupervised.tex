...
\textit{Initiative}-amplifier produces a clean on-target effect ($+1.5\sigma$ on the target factor; rising to $+1.8\sigma$ on personas with most baseline headroom), but with substantial off-target spillover --- most notably driving \textit{Epistemic Caution} down by $-1.2\sigma$.
...
The amplifier produces a clean $+1.5\sigma$ on-target effect (rising to $+1.8\sigma$ on the most-headroom personas) but pulls \textit{Epistemic Caution} down by $-1.2\sigma$. The corresponding heatmap for all four trained LoRAs --- including the \textit{Tone} amplifier/suppressor --- and the full-sample and headroom-conditioned views are in Appendix~\ref{sec:appendix-fa-lora-shifts}.}
