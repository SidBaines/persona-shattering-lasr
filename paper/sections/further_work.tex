...
The study of LLM personas is a burgeoning field with much work to be done, and we would love to see various improvements and extensions to this work.
...
\textbf{Further study into the relationship between trait space and personas.} Our work studying the traits we have has been limited to performing statistical analysis and visualising the flattened LoRA vectors.
There could be a better (i.e.
more predictive or more explainable) way of embedding this information, and we would be excited by work which seeks to discover this.

\textbf{More unsupervised exploration of personas.} From a safety perspective, understanding the non-human traits of LLMs is useful.
